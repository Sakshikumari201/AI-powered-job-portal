...
const DashboardHome = () => {
  ...
  const skillCount = latestAnalysis?.extractedSkills?.length || 0;
  const topJobScore = latestAnalysis?.recommendedJobs?.[0]?.matchScore || 0;
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-8">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        ...
        <Link
          to="/upload"
          className="hidden md:flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-primary-600 to-accent-600 text-white text-sm font-semibold rounded-xl hover:from-primary-700 hover:to-accent-700 shadow-lg shadow-primary-200 transition-all active:scale-[0.97]"
        >
      ...
      {!hasAnalysis ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 animate-fade-in-up">
          ...
          <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-2">No analysis yet</h2>
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 text-center max-w-md">
            Upload your resume to get an instant AI-powered ATS score, skill gap analysis, and personalized job recommendations.
          </p>
          <Link
            to="/upload"
            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-primary-600 to-accent-600 text-white font-semibold rounded-xl hover:from-primary-700 hover:to-accent-700 shadow-lg shadow-primary-200 transition-all"
          >
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-5">
            ...
            <div className="lg:col-span-2 bg-white dark:bg-dark-card rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-dark-border animate-fade-in-up stagger-3">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  ...
                  <span className="text-sm font-bold text-gray-900 dark:text-white">{Math.round(topJobScore)}%</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold text-gray-900 dark:text-white">{missingSkills.length}</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-xl">
                  <div className="flex items-center gap-3">
            ...
            {/* Analysis History Trend */}
            <div className="lg:col-span-3 bg-white dark:bg-dark-card rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-dark-border animate-fade-in-up stagger-4">
              <div className="flex items-center justify-between mb-4">
